...
create table phone(phone_id serial primary key, phone_number char(12), user_id integer REFERENCES Users(user_id))

create table email(email_id serial primary key, email_address varchar(64), user_id integer REFERENCES Users(user_id))
