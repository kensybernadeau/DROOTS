...
CREATE TABLE  Resouces(resource_id  serial PRIMARY KEY, resource_name VARCHAR(20) , resouce_category VARCHAR (20))
...
CREATE TABLE Request(request_id serial PRIMARY KEY, customer_id REFERENCES Customer(customer_id))

CREATE TABLE Reservation(reservation_id serial PRIMARY KEY, customer_id REFERENCES Customer(customer_id) )
