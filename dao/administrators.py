...
class AdministratorsDAO:
    ...
    def getAllAdmins(self):
        ...
        query = "select user_id, admin_id, user_first_name, user_last_name, user_location, user_name, user_password " \
                "from administrators natural inner join users;"
    ...
    def getAdminById(self, admin_id):
        cursor = self.conn.cursor()
        query = "select user_id, admin_id, user_first_name, user_last_name, user_location, user_name, user_password " \
                "from administrators natural inner join users where admin_id = %s;"
