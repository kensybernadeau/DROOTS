...
class CustomerDAO:
    ...
    def getAllCustomers(self):
        ...
        query = "select user_id, customer_id, user_first_name, user_last_name, user_location, user_name, user_password " \
                "from customer natural inner join users;"
    ...
    def getCustomerById(self, customer_id):
        cursor = self.conn.cursor()
        query = "select user_id, customer_id, user_first_name, user_last_name, user_location, user_name, user_password " \
                "from customer natural inner join users where customer_id = %s;"
