...
class HealthDAO:
    ...
    def insert_health(self, resource_name, health_exp_date, health_type, health_description, resource_date):
        resource_id = ResourcesDAO().insert_resource(resource_name, 'health', resource_date)
        cursor = self.conn.cursor()
